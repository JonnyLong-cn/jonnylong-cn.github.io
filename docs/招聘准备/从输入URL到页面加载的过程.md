> 原文来自：[从输入URL到页面加载的过程？如何由一道题完善自己的前端知识体系！ | Dailc的个人主页 (dailichun.com)](http://www.dailichun.com/2018/03/12/whenyouenteraurl.html)
...
![img](从输入URL到页面加载的过程/browser_process_list2.png)
...
![img](从输入URL到页面加载的过程/browser_inner_thread.png)
...
![img](从输入URL到页面加载的过程/http_status_brief.png)
...
![img](从输入URL到页面加载的过程/http_ajax_headers.png)
...
![img](从输入URL到页面加载的过程/http_cookie_session.png)
...
![img](从输入URL到页面加载的过程/https_connect_simple.png)
...
![img](从输入URL到页面加载的过程/http_cache.png)
...
![img](从输入URL到页面加载的过程/browser_rending.png)
...
![img](从输入URL到页面加载的过程/browser_parse_html.png)
...
![img](从输入URL到页面加载的过程/browser_parse_dom.png)
...
![img](从输入URL到页面加载的过程/browser_parse_cssom.png)
...
![img](从输入URL到页面加载的过程/browser_parse_rendertree.png)

## 渲染

有了render树，接下来就是开始渲染，基本流程如下：

![img](从输入URL到页面加载的过程/browser_rendingprocess.jpg)
...
![img](从输入URL到页面加载的过程/browser_chrome_debug_1.png) ![img](https://dailc.github.io/staticResource/blog/basicKnowledge/whenyouenteraurl/browser_chrome_debug_2.png)
...
![img](从输入URL到页面加载的过程/js_engine_context_stack.png)
...
![img](从输入URL到页面加载的过程/js_engine_context.png)
...
![img](从输入URL到页面加载的过程/js_engine_scopechain.png)
